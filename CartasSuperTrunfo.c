...
int main() {
    ...
    float area; //Declaração da variável área, utilizando números flutuantes
    ...
    scanf(" %f", &area); //Permite a inserção do dado "area" no terminal
    printf("\nDigite o PIB: "); //Exibe a mensagem no terminal solicitando a inserção do dado "PIB"
    scanf(" %f", &pib); //Permite a inserção do dado "PIB" no terminal
    ...
    printf("pontos turísticos: %d", turismo); //Exibe o dado "turismo" digitado anteriormente, no terminal
}
